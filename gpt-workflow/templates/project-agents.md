...
修改论文／报告按 `references/protocols/revision.md` 保留原稿基准及当前工作稿，小改沿用工作稿并保留差异，大改或里程碑再另存；沿用原格式。写作按 `references/writing-guide.md` 的四体例及真实 exemplar，个人明确修改优先。不为去 AI 味删除必要条件或加强因果含义。
