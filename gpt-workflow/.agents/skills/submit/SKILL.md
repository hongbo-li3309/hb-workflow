...
- `target`: compare fit of the economic question, contribution and evidence to actual recent papers; check official requirements using `references/journal-profiles.md`. Separate rules from judgment; avoid prestige-based demands for additional models.
